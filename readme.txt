...
player: We have two Python servers that have nothing better to do than to play number-guessing with each other. The first server serves as the "player" and the second as the "game master". Their common language is HTTP requests. The numbers are between 1 and 1000, but should be configurable.
